                    ...
                    <div class="car-details-section">
                        ...
                        <div class="product-slider-box clearfix mb-30">
                            <div class="product-img-slide">
                                ...
                                <div class="slider-nav">
                                    @foreach(json_decode($carro->imagem) as $imagem)
                                        <div class="thumb-slide"><img src="/img/cars/{{ $imagem }}" class="img-fluid" alt="small-car"></div>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tabbing tabbing-box mb-40">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Especificações</button>
                                </li>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floating-full-name" placeholder="Nome completo">
                                            <label for="floating-full-name">Nome completo</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control" id="floating-email-address" placeholder="E-mail">
                                            <label for="floating-email-address">E-mail</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floating-subject" placeholder="Assunto">
                                            <label for="floating-subject">Assunto</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floating-phone-Number" placeholder="Número de telefone">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="floatingTextarea2">Tenho que ajustar envio de Mensagem ou de Comentários</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                        ...
                        <div class="contact-1 financing-calculator widget widget-3">
                            ...
                            <form id="financing-form" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-0">
                                    <button type="button" class="btn btn-primary btn-4 btn-lg" id="calculateBtn">Calcular</button>
                                </div>
                            </form>
                        </div>
