    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="row team-6 g-0">
                    <div class="col-lg-5 col-md-12">
                        <div class="team-thumb">
                            <a href="team-detail.html">
                                <img src="img/avatar/avatar-12.png" alt="team" class="img-fluid w-100">
                            </a>
                            <div class="team-social flex-middle">
                                <div class="team-overlay"></div>
                                <div class="team-social-inner">
                                    <a rel="nofollow" href="#" class="facebook-bg" tabindex="0">
                                        <i class="fa fa-facebook" aria-hidden="true"></i>
                                    </a>
                                    <a rel="nofollow" href="#" class="twitter-bg" tabindex="0">
                                        <i class="fa fa-twitter" aria-hidden="true"></i>
                                    </a>
                                    <a rel="nofollow" href="#" class="google-bg" tabindex="0">
                                        <i class="fa fa-google" aria-hidden="true"></i>
                                    </a>
                                    <a rel="nofollow" href="#" class="linkedin-bg" tabindex="0">
                    ...
                    <div class="col-lg-7 col-md-12 align-self-center">
                        <div class="details">
                            <h3><a href="team-detail.html">Brandon Miller</a></h3>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="row team-6 g-0">
                    <div class="col-lg-5 col-md-12">
                        <div class="team-thumb">
                            <a href="team-detail.html">
                                <img src="img/avatar/avatar-11.png" alt="team" class="img-fluid w-100">
                            </a>
                            <div class="team-social flex-middle">
                                <div class="team-overlay"></div>
                                <div class="team-social-inner">
                    ...
                    <div class="col-lg-7 col-md-12 align-self-center">
                        <div class="details">
                            <h3><a href="team-detail.html">Emma Connor</a></h3>
