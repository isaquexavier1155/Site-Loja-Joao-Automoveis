    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <!-- Services details box start -->
                <div class="services-details-box mb-50 service-box">
                    <div class="blog-photo">
                        <img src="img/service/img-4.png" alt="service-photo" class="img-fluid w-100">
                    </div>
                    <div class="detail">
                        <h3>
                            <a href="#">Our featured services</a>
                        </h3>
                        ...
                        <h3>
                            <a href="#">We guarantee to deliver</a>
                        </h3>
                        ...
                        <ul class="amenities">
                            ...
                            <li>
                                <i class="fa fa-check"></i>We handle all makes and models in more than 254 car brands
                            </li>
                            <li>
                                <i class="fa fa-check"></i>We are endorsed by the local trading standards office
                            </li>
                            <li>
                ...
                <div class="sidebar-right">
                    ...
                    <div class="posts-by-category widget">
                        ...
                        <ul class="list-unstyled list-cat">
                            <li><a href="#">Business Rentals <span>(19)</span></a></li>
                            <li><a href="#">Luxury Rentals <span>(22) </span></a></li>
                            <li><a href="#">Traveling Rentals <span>(45)</span></a></li>
                            <li><a href="#">Pickup Truck <span>(21)</span> </a></li>
                        </ul>
                    </div>
                    <!-- Latest tweet start -->
                    <div class="widget latest-tweet widget-3">
                        <h3 class="sidebar-title">Tweet</h3>
                        <P class="mb-0"><a href="#">Lorem Ipsum is simply dummy text</a> of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</P>
                    </div>
                </div>
            </div>
        </div>
