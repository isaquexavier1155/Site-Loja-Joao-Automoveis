...
<div class="car-details-page content-area shop-details">
    <div class="container">
       <div class="col-lg-12">
           <div class="row shop-info g-0">
               <div class="col-xl-5 col-lg-6">
                   <div class="product-slider-box clearfix">
                       <div class="product-img-slide">
                           <div class="slider-for">
                               <img src="img/shop/img-4.png" class="img-fluid" alt="slider-photo">
                               <img src="img/shop/img-5.png" class="img-fluid" alt="slider-photo">
                               <img src="img/shop/img-3.png" class="img-fluid" alt="slider-photo">
                               <img src="img/shop/img-2.png" class="img-fluid" alt="slider-photo">
                               <img src="img/shop/img.png" class="img-fluid" alt="slider-photo">
                           </div>
                           <div class="slider-nav">
                               <div class="thumb-slide"><img src="img/shop/img-4.png" class="img-fluid" alt="small-photo"></div>
                               <div class="thumb-slide"><img src="img/shop/img-5.png" class="img-fluid" alt="small-photo"></div>
                               <div class="thumb-slide"><img src="img/shop/img-3.png" class="img-fluid" alt="small-photo"></div>
                               <div class="thumb-slide"><img src="img/shop/img-2.png" class="img-fluid" alt="small-photo"></div>
                               <div class="thumb-slide"><img src="img/shop/img.png" class="img-fluid" alt="small-photo"></div>
                           </div>
                       </div>
                   </div>
               </div>
               <div class="col-xl-7 col-lg-6">
                   <div class="inner">
                       ...
                       <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar. Donec a consectetur nulla. Nulla posuere sapien vitae lectus suscipit,<span class="d-none-1200"> et pulvinar nisi tincidunt. Aliquam erat volutpat. Curabitur convallis fringilla diam sed aliquam. Sed tempor iaculis massa faucibus feugiat. In fermentum facilisis massa.</span></p>
                       <form>
                           <div class="row mb-4">
                               <div class="col-4 form-group">
                                   <input type="number" class="form-control" id="quantity" name="quantity" min="1" max="9">
                               </div>
                               <div class="col-8 form-group">
                                   <button type="button" class="btn btn-primary btn-4 btn-lg btn-w-100">Proceed To Checkout</button>
                               </div>
                           </div>
                       </form>
                       <P class="mb-0">Category: <a href="#">Car</a> Tags:<a href="#">Accessories</a>,<a href="#">Detector</a>,<a href="#">Electronics</a></P>
                   </div>
               </div>
           </div>
       </div>
                    ...
                    <div class="contact-1 financing-calculator widget widget-3">
                        ...
                        <form action="#" method="GET" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputprice" placeholder="$24.400">
                            </div>
                            <div class="form-group">
                                <label for="inputinterest" class="form-label">Interest Rate (%)</label>
                                <input type="text" class="form-control" id="inputinterest" placeholder="15%">
                            </div>
                            <div class="form-group">
                                <label for="inputperiod" class="form-label">Period In Months</label>
                                <input type="text" class="form-control" id="inputperiod" placeholder="6 Months">
                            </div>
                            <div class="form-group">
                                <label for="inputpayment" class="form-label">Down Payment</label>
                                <input type="text" class="form-control" id="inputpayment" placeholder="$32,300">
                            </div>
                            <div class="form-group mb-0">
                                <button type="button" class="btn btn-primary btn-4 btn-lg">Cauculate</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="shop-box">
                    <div class="shop-photo">
                        <img class="shop-theme img-fluid" src="img/shop/img.png" alt="img">
                        <div class="overlay">
                            <div class="text-section">
                                <a href="shop-details.html" class="btn add-btn">Add to Cart</a>
                            </div>
                        </div>
                    </div>
                    <div class="shop-info">
                        <h4>
                            <a href="shop-details.html">Car Brakes</a>
                        </h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="shop-box">
                    <div class="shop-photo">
                        <img class="shop-theme img-fluid" src="img/shop/img-2.png" alt="img">
                        <div class="overlay">
                            <div class="text-section">
                                <a href="shop-details.html" class="btn add-btn">Add to Cart</a>
                            </div>
                    ...
                    <div class="shop-info">
                        <h4>
                            <a href="shop-details.html">Car Rims</a>
                        </h4>
                        <div class="sale-price">
                            <span class="del"><del>$950.00</del></span><span>$770.00</span>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="shop-box">
                    <div class="shop-photo">
                        <img class="shop-theme img-fluid" src="img/shop/img-3.png" alt="img">
                        <div class="overlay">
                            <div class="text-section">
                                <a href="shop-details.html" class="btn add-btn">Add to Cart</a>
                            </div>
                    ...
                    <div class="shop-info">
                        <h4>
                            <a href="shop-details.html">Car Wheel</a>
                        </h4>
                        <div class="sale-price">
                            <span class="del"><del>$950.00</del></span><span>$770.00</span>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="shop-box">
                    <div class="shop-photo">
                        <img class="shop-theme img-fluid" src="img/shop/img-4.png" alt="img">
                        <div class="overlay">
                            <div class="text-section">
                                <a href="shop-details.html" class="btn add-btn">Add to Cart</a>
                            </div>
                    ...
                    <div class="shop-info">
                        <h4>
                            <a href="shop-details.html">Air Compressor</a>
                        </h4>
                        <div class="sale-price">
                            <span class="del"><del>$950.00</del></span><span>$770.00</span>
                        </div>
