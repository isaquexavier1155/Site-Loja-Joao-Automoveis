...
<!-- Icon lists start -->
<div class="icon-lists content-area-20">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="heading-2 mb-2">Linearicons</h1>
                <mark>Usage: &nbsp; &lt;i class="lnr lnr-home"&gt;&lt;/i&gt;</mark>
                <div class="row mhl ptl">
                    <div class="glyph fs1 col-md-4 col-sm-4 col-lg-2 col-6">
