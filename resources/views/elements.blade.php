...
<!-- Elements page start -->
<div class="elements-page content-area-19">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="accordion-example-box mb-50">
                    <h3 class="heading-2">Accordion example</h3>
                    <div class="faq-info">
                ...
                <div class="button-section mb-50">
                    <h3 class="heading-2">Button</h3>
                    <div class="buttons">
                        ...
                        <br><br>
                        <button type="button" class="btn btn-outline-primary bomd">Primary</button>
                        <button type="button" class="btn btn-outline-secondary bomd">Secondary</button>
                        <button type="button" class="btn btn-outline-success bomd">Success</button>
                        <button type="button" class="btn btn-outline-danger bomd">Danger</button>
                        <button type="button" class="btn btn-outline-warning bomd">Warning</button>
                        <button type="button" class="btn btn-outline-info bomd">Info</button>
                        <button type="button" class="btn btn-outline-dark bomd">Dark</button>
                    </div>
                </div>
                <div class="table-box mb-50">
            ...
            <div class="col-lg-6">
                ...
                <div class="progress-box mb-50">
                    <h3 class="heading-2">Progress</h3>
                    <div class="progress">
                ...
                <div class="faq-box mb-50">
                    <h3 class="heading-2">Tab</h3>
                    <div class="faq-info">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home2" type="button" role="tab" aria-controls="home2" aria-selected="true">Home</button>
                            </li>
                            <li class="nav-item" role="presentation">
                ...
                <div class="active-items-box mb-50">
                    <h3 class="heading-2">Active items</h3>
                    <div class="list-group">
                        <button type="button" class="list-group-item list-group-item-action active bg-active" aria-current="true">
                            The current button
                        </button>
