        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <table class="shop-table cart">
                    ...
                    <tr>
                        <td class="product-thumbnail"><img src="img/shop/img-3.png" alt="img"></td>
                        <td class="product-name">
                            <a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ac tortor</a>
                        </td>
                        <td class="d_none">£58.00</td>
                    ...
                    <tr>
                        <td class="product-thumbnail"><img src="img/shop/img-4.png" alt="img"></td>
                        <td class="product-name">
                            <a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ac tortor</a>
                        </td>
                        <td class="d_none">£58.00</td>
                    ...
                    <tr>
                        <td class="product-thumbnail"><img src="img/shop/img-5.png" alt="img"></td>
                        <td class="product-name">
                            <a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ac tortor</a>
                        </td>
                        <td class="d_none">£58.00</td>
            ...
            <div class="col-lg-4">
                <div class="cart-total-box">
                    ...
                    <br>
                    <button type="button" class="btn btn-success btn-4 btn-lg mb-3">Update Cart</button>
                    <button type="button" class="btn btn-primary btn-4 btn-lg">Proceed To Checkout</button>
                </div>
            </div>
        </div>
    </div>
