...
<!-- Shop checkout start -->
<div class="shop-checkout content-area-5 contact-1">
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    ...
                    <form action="#" method="GET" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="State Country" aria-label="State / Country">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="payment-box mb-4">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label " for="flexSwitchCheckDefault">
                                    <span class="default clearfix">Direct Bank Transfer</span>
