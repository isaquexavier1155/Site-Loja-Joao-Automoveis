...
<!-- Main header start -->
<header class="main-header sticky-header main-header-4">
    <div class="container">
        <div class="header-inner">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand company-logos" href="index.html">
...
<div class="banner-2">
    <div class="slider-container">
        ...
        <div class="right-slide">
            <div style="background-image: url('img/car-6.png')"></div>
            <div style="background-image: url('img/car-7.png')"></div>
            <div style="background-image: url('img/car-8.png')"></div>
        </div>
...
<!-- Featured car start -->
<div class="featured-car-section comon-slick content-area">
    <div class="container">
        <!-- Main title -->
        ...
        <div class="slick row" data-slick='{"slidesToShow": 3, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
            <div class="item">
                <div class="car-box-4 car-photo-1 bg">
            ...
            <div class="item">
                <div class="car-box-4 car-photo-3 bg">
                    <div class="tag-2 bg-active">For Rent</div>
                    <div class="ling-section">
                        <h3>
            ...
            <div class="item">
                <div class="car-box-4 car-photo-4 bg">
            ...
            <div class="item">
                <div class="car-box-4 car-photo-2 bg">
                    <div class="tag-2 bg-active">For Sale</div>
                    <div class="ling-section">
                        <h3>
...
<div class="service-section-3 content-area bg-grea-4">
    <div class="container">
        <!-- Main title -->
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="service-info-4">
                    ...
                    <h3>
                        <a href="services-details.html">Highly Secured</a>
                    </h3>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="service-info-4">
                    ...
                    <h3>
                        <a href="services-details.html">Trusted Agents</a>
                    </h3>
                    <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan.</p>
                    <a href="#" class="read-more-btn">Read More</a>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="service-info-4">
                    ...
                    <h3>
                        <a href="services-details.html">Get an Offer</a>
                    </h3>
                    <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan.</p>
                    <a href="#" class="read-more-btn">Read More</a>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="service-info-4">
                    ...
                    <h3>
                        <a href="services-details.html">Free Support</a>
                    </h3>
                    <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan.</p>
                    <a href="#" class="read-more-btn">Read More</a>
                </div>
    ...
    <div class="container">
        ...
        <div class="featured-slider row slide-box-btn slider" data-slick='{"slidesToShow": 4, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
            <div class="slide slide-box">
                <div class="team-4">
                    <div class="member-thumb">
                        <img src="img/avatar/avatar-6.png" alt="team-4" class="img-fluid">
                    </div>
                    <div class="member-content-wrap">
                        <div class="member-name-designation">
                            <h4 class="member-name">
                                <a href="team-detail.html">Michelle Nelson</a>
                            </h4>
            ...
            <div class="slide slide-box">
                <div class="team-4">
                    <div class="member-thumb">
                        <img src="img/avatar/avatar-7.png" alt="team-4" class="img-fluid">
                    </div>
                    <div class="member-content-wrap">
                        <div class="member-name-designation">
                            <h4 class="member-name">
            ...
            <div class="slide slide-box">
                <div class="team-4">
                    <div class="member-thumb">
                        <img src="img/avatar/avatar-8.png" alt="team-4" class="img-fluid">
                    </div>
                    <div class="member-content-wrap">
                        <div class="member-name-designation">
                            <h4 class="member-name">
                                <a href="team-detail.html">Karen Paran</a>
                            </h4>
            ...
            <div class="slide slide-box">
                <div class="team-4">
                    <div class="member-thumb">
                        <img src="img/avatar/avatar-13.png" alt="team-4" class="img-fluid">
                    </div>
                    <div class="member-content-wrap">
                        <div class="member-name-designation">
                            <h4 class="member-name">
                                <a href="team-detail.html">Martin Smith</a>
                            </h4>
                            ...
                            <div class="testimonial-info">
                                <div class="row">
                                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                        <div class="avatar">
                                            <img src="img/avatar/avatar-1.png" alt="testimonial-3" class="img-fluid">
                                        </div>
                                    </div>
                        ...
                        <div class="carousel-item">
                            <div class="testimonial-info">
                                <div class="row">
                                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                        <div class="avatar">
                                            <img src="img/avatar/avatar-2.png" alt="testimonial-3" class="img-fluid">
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                        <div class="info-section">
                        ...
                        <div class="carousel-item">
                            <div class="testimonial-info">
                                <div class="row">
                                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                        <div class="avatar">
                                            <img src="img/avatar/avatar-3.png" alt="testimonial-3" class="img-fluid">
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                        <div class="info-section">
