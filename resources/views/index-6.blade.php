    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item item-bg">
                <img class="d-block w-100 h-100" src="img/car-15.png" alt="banner">
                <div class="carousel-content container banner-info-2 bi-2 text-l">
            ...
            <div class="carousel-item item-bg">
                <img class="d-block w-100 h-100" src="img/car-4.png" alt="banner">
                <div class="carousel-content container banner-info-2 bi-2 text-l">
                    <h3>We Are Wheel</h3>
                    <h5>Allow us to guide you through the innovative stress<br>
                        free approach in finding your dream car.</h5>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-md-7 col-sm-12">
                <div class="info">
                    <h3>Are You Looking For Car House Consultation?</h3>
                </div>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-12">
                <a class="btn btn-6 btn-lg" href="contact.html">
                    Get in Touch
                </a>
            </div>
        </div>
