    ...
    <div class="container breadcrumb-area">
        <div class="breadcrumb-areas">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="active">Compare Vehicles</li>
            </ul>
        </div>
    </div>
</div>
...
<!-- Car comparison car start -->
<div class="Car-comparison content-area-15">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form method="GET">
                    <div class="row sidebar search-compare">
                        <div class="col-md-12 col-lg-12">
                            <h3>Select Car's You Want To Compare</h3>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                            <div class="form-group">
                                <select class="selectpicker search-fields" name="select">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                            <div class="form-group">
                                <select class="selectpicker search-fields" name="audi">
                                    <option>Audi</option>
                                    <option>BMW</option>
                                    <option>Honda</option>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                                <button class="btn btn-lg btn-primary btn-4 btn-w-100">Search</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="compare-vehicles-box bg-grea-3">
            <div class="row">
                <div class="col-lg-5 col-md-12">
                    <div class="vehicles-box">
                        <div class="car-photo">
                            <a href="car-details.html" class="car-img">
                                <img class="d-block w-100" src="img/compear/car-1.png" alt="car">
                            </a>
                        </div>
                        <div class="detail">
                            <h5>$975.00</h5>
                            <h4 class="title">
                                <a href="car-details.html">2018 Maserati Ghibli</a>
                            </h4>
                            <div class="ratings">
                ...
                <div class="col-lg-2 col-md-12 align-self-center">
                    <div class="vs-section">
                        <div class="vs">
                            <img src="img/vs.png" alt="vs" class="f-logo">
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 col-md-12">
                    <div class="vehicles-box">
                        <div class="car-photo">
                            <a href="car-details.html" class="car-img">
                                <img class="d-block w-100" src="img/compear/car-2.png" alt="car">
                            </a>
                        </div>
                        <div class="detail">
                            <h5>$975.00</h5>
                            <h4 class="title">
                                <a href="car-details.html">BMW Transparent</a>
                            </h4>
                            <div class="ratings">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
