...
<div class="pricing-tables content-area">
    <div class="container">
        ...
        <div class="main-title text-center">
            <h1>Pricing <span>Tables</span></h1>
                ...
                <div class="pricing-1 plan">
                    ...
                    <div class="plan-list">
                        <ul>
                            ...
                            <li><i class="fa fa-envelope-o"></i>1000 Email Addresses</li>
                        ...
                        <div class="plan-button text-center">
                            <button type="button" class="btn btn-sm btn-outline-primary">Get Started</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-12">
                <div class="pricing-1 plan">
                    ...
                    <div class="plan-list">
                        ...
                        <div class="plan-button text-center">
                            <button type="button" class="btn btn-sm btn-primary">Get Started</button>
                        </div>
                    </div>
                </div>
            </div>
