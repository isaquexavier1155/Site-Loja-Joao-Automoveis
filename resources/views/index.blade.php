...
<html lang="zxx">
<head>
    <title>Car House - Automobile HTML5 Template</title>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-3">
                <div class="top-logo">
                    <a href="index.html"><img src="img/logos/black-logo.png" alt="logo"></a>
                </div>
            </div>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item item-bg active">
                <img class="d-block w-100 h-100" src="img/car-1.png" alt="banner">
                <div class="carousel-content container banner-info-2 bi-2 text-l">
                    ...
                    <a href="#" class="btn btn-lg btn-3">Order Now</a>
                    <a href="#" class="btn btn-lg btn-2">Test Drive</a>
                </div>
            </div>
            <div class="carousel-item item-bg">
                <img class="d-block w-100 h-100" src="img/car-2.png" alt="banner">
                <div class="carousel-content container banner-info-2 bi-2 text-l">
            ...
            <div class="carousel-item item-bg">
                <img class="d-block w-100 h-100" src="img/car-3.png" alt="banner">
                <div class="carousel-content container banner-info-2 bi-2 text-l">
                    <h3>We Are Wheel</h3>
                    <h5>Allow us to guide you through the innovative stress<br>
                        free approach in finding your dream car.</h5>
                            ...
                            <div class="overlap-box">
                                <div class="overlap-btns-area">
                                    ...
                                    <div class="car-magnify-gallery">
                                        <a href="img/car/car-1.png" class="overlap-btn" data-sub-html="<h4>Lamborghini Huracán</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                            <i class="fa fa-expand"></i>
                                            <img class="hidden" src="img/car/car-1.png" alt="hidden-img">
                                        </a>
                                        <a href="img/car/car-2.png" class="hidden" data-sub-html="<h4>Lexus GS Red Car</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                            <img class="hidden" src="img/car/car-2.png" alt="hidden-img">
                                        </a>
                                        <a href="img/car/car-3.png" class="hidden" data-sub-html="<h4>2015 Porsche Cayenne</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                            <img class="hidden" src="img/car/car-3.png" alt="hidden-img">
                                        </a>
                                        <a href="img/car/car-4.png" class="hidden" data-sub-html="<h4>Toyota Corolla</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                            <img class="hidden" src="img/car/car-4.png" alt="hidden-img">
                                        </a>
                                        <a href="img/car/car-5.png" class="hidden" data-sub-html="<h4>Toyota Prius Specs</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                        ...
                        <div class="carbox-overlap-wrapper">
                            <div class="overlap-box">
                                <div class="overlap-btns-area">
                                    ...
                                    <div class="car-magnify-gallery">
                                        <a href="img/car/car-2.png" class="overlap-btn" data-sub-html="<h4>Lexus GS Red Car</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                            <i class="fa fa-expand"></i>
                                            <img class="hidden" src="img/car/car-2.png" alt="hidden-img">
                                        </a>
                                        <a href="img/car/car-1.png" class="hidden" data-sub-html="<h4>Lexus GS Red Car</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                            <img class="hidden" src="img/car/car-1.png" alt="hidden-img">
                                        </a>
                                        <a href="img/car/car-3.png" class="hidden" data-sub-html="<h4>2015 Porsche Cayenne</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                            <img class="hidden" src="img/car/car-3.png" alt="hidden-img">
                        ...
                        <div class="carbox-overlap-wrapper">
                            <div class="overlap-box">
                                <div class="overlap-btns-area">
                                    ...
                                    <div class="car-magnify-gallery">
                                        <a href="img/car/car-3.png" class="overlap-btn" data-sub-html="<h4>2015 Porsche Cayenne</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                            <i class="fa fa-expand"></i>
                                            <img class="hidden" src="img/car/car-3.png" alt="hidden-img">
                                        </a>
                                        <a href="img/car/car-2.png" class="hidden" data-sub-html="<h4>Lexus GS Red Car</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                        ...
                                        <a href="img/car/car-1.png" class="hidden" data-sub-html="<h4>Lamborghini Huracán</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                            <img class="hidden" src="img/car/car-1.png" alt="hidden-img">
                                        </a>
                                        <a href="img/car/car-4.png" class="hidden" data-sub-html="<h4>Toyota Corolla</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                            <img class="hidden" src="img/car/car-4.png" alt="hidden-img">
                        ...
                        <div class="carbox-overlap-wrapper">
                            <div class="overlap-box">
                                <div class="overlap-btns-area">
                                    ...
                                    <div class="car-magnify-gallery">
                                        <a href="img/car/car-4.png" class="overlap-btn" data-sub-html="<h4>Toyota Corolla</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                            <i class="fa fa-expand"></i>
                                            <img class="hidden" src="img/car/car-4.png" alt="hidden-img">
                                        </a>
                                        <a href="img/car/car-2.png" class="hidden" data-sub-html="<h4>Lexus GS Red Car</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
        ...
        <div class="row">
            <div class="col-xl-5 col-lg-4 align-self-center">
                ...
                <div class="main-title main-title-3">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod</p>
                    <a href="services.html" class="btn btn-1 btn-md important-btn"><span>Read More</span></a>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="service-info-3">
                            ...
                            <div class="content">
                                <h3><a href="services-details.html">Highly Secured</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt eiusmod tempor incididunt eiusmod</p>
                                <a class="button btn-txt" href="services-details.html">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="service-info-3">
                            ...
                            <div class="content">
                                <h3><a href="services-details.html">Trusted Agents</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt eiusmod tempor incididunt eiusmod</p>
                                <a class="button btn-txt" href="services-details.html">Read More</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="service-info-3">
                            ...
                            <div class="content">
                                <h3><a href="services-details.html">Get an Offer</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt eiusmod tempor incididunt eiusmod</p>
                                <a class="button btn-txt" href="services-details.html">Read More</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="service-info-3">
                            ...
                            <div class="content">
                                <h3><a href="services-details.html">Free Support</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt eiusmod tempor incididunt eiusmod</p>
                                <a class="button btn-txt" href="services-details.html">Read More</a>
                            </div>
                        </div>
                                ...
                                <div class="latest-offers-box-overflow">
                                    <div class="latest-offers-box-photo">
                                        <div class="latest-offers-box-photodd">
                                            <img class="img-fluid w-100" src="img/latest-offers/img-3.png" alt="latest-offers">
                                        </div>
                                    </div>
                                    <div class="info">
                                        <h5 class="price">1050.00 <span>Fixed</span></h5>
                                        <h3 class="title">
                                            <a href="car-details.html">Electric Cars of 2019</a>
                                        </h3>
                                    </div>
                        ...
                        <div class="latest-offers-box">
                            <div class="latest-offers-box-inner">
                                <div class="latest-offers-box-overflow">
                                    <div class="latest-offers-box-photo">
                                        <div class="latest-offers-box-photodd">
                                            <img class="img-fluid w-100" src="img/latest-offers/img-2.png" alt="latest-offers">
                                        </div>
                                    </div>
                                    <div class="info">
                                        <h5 class="price">1050.00 <span>Negotiable</span></h5>
                                        <h3 class="title">
                                            <a href="car-details.html">Lamborghini Huracán</a>
                                        </h3>
                                    </div>
                        ...
                        <div class="latest-offers-box">
                            <div class="latest-offers-box-inner">
                                <div class="latest-offers-box-overflow">
                                    <div class="latest-offers-box-photo">
                                        <div class="latest-offers-box-photodd">
                                            <img class="img-fluid w-100" src="img/latest-offers/img-5.png" alt="latest-offers">
                                        </div>
                                    </div>
                                    <div class="info">
                                        <h5 class="price">1050.00 <span>Negotiable</span></h5>
                ...
                <div class="latest-offers-box">
                    <div class="latest-offers-box-inner">
                        <div class="latest-offers-box-overflow">
                            <div class="latest-offers-box-photo">
                                <div class="latest-offers-box-photodd">
                                    <img class="img-fluid big-img w-100" src="img/latest-offers/img-1.png" alt="latest-offers">
                                </div>
                            </div>
                            <div class="info">
                                <h5 class="price">959.00 <span>Negotiable</span></h5>
                                <h3 class="title">
                                    <a href="car-details.html">Red Audi R8 2018</a>
                                </h3>
                            </div>
                            <div class="new">New</div>
                        </div>
    ...
    <div class="container">
        ...
        <div class="featured-slider row slide-box-btn slider" data-slick='{"slidesToShow": 4, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
            <div class="slide slide-box">
                <div class="team-1">
                    <div class="photo">
                        <img src="img/avatar/avatar-12.png" alt="team-1" class="img-fluid">
                        <div class="overlay">
                            <div class="border">
            ...
            <div class="slide slide-box">
                <div class="team-1">
                    <div class="photo">
                        <img src="img/avatar/avatar-9.png" alt="team-1" class="img-fluid">
                        <div class="overlay">
                            <div class="border">
                                <div class="icon-holder">
                                    <a href="#" class="facebook-bg"><i class="fa fa-facebook"></i></a>
            ...
            <div class="slide slide-box">
                <div class="team-1">
                    <div class="photo">
                        <img src="img/avatar/avatar-11.png" alt="team-1" class="img-fluid">
                        <div class="overlay">
                            <div class="border">
                                <div class="icon-holder">
                                    <a href="#" class="facebook-bg"><i class="fa fa-facebook"></i></a>
            ...
            <div class="slide slide-box">
                <div class="team-1">
                    <div class="photo">
                        <img src="img/avatar/avatar-10.png" alt="team-1" class="img-fluid">
                        <div class="overlay">
                            <div class="border">
                                <div class="icon-holder">
                                    <a href="#" class="facebook-bg"><i class="fa fa-facebook"></i></a>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="testimonial-info">
                                ...
                                <div class="avatar">
                                    <img src="img/avatar/avatar-1.png" alt="testimonial-user">
                                </div>
                                <h4>Karen Paran</h4>
                        ...
                        <div class="carousel-item">
                            <div class="testimonial-info">
                                ...
                                <div class="avatar">
                                    <img src="img/avatar/avatar-4.png" alt="testimonial-user">
                                </div>
        ...
        <div class="featured-slider row slide-box-btn slider" data-slick='{"slidesToShow": 3, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                ...
                <div class="blog-2">
                    <div class="photo">
                        ...
                        <div class="overlay-icon">
                            <a href="blog-details.html"><span><i class="fa fa-plus-square-o span"></i></span></a>
                        </div>
                    </div>
            ...
            <div class="slide slide-box">
                <div class="blog-2">
                    ...
                    <div class="blog-one__single-text-box detail">
                        <h3 class="title">
                            <a href="blog-details.html">What's new coming from the carhouse in future?</a>
                        </h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the</p>
                        <ul class="post-meta">
                            <li><i class="fa fa-calendar" aria-hidden="true"></i>25 June 2021</li>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item clearfix">
                    ...
                    <ul class="contact-info">
                        ...
                        <li>
                            <i class="flaticon-earth"></i><a href="mailto:sales@hotelempire.com">carhouse@themevessel.com</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="links">
                        <li>
                            <a class="link-inner"><span> Home</span></a>
                        </li>
                        <li>
                            <a class="link-inner"><span> About Us</span></a>
                        </li>
                        <li>
                            <a class="link-inner"><span> Services</span></a>
                        </li>
                        <li>
                            <a class="link-inner"><span> Car Listing</span></a>
                        </li>
                        <li>
                            <a class="link-inner"><span> Blog</span></a>
                        </li>
                        <li>
                            <a class="link-inner"><span> Gallery</span></a>
                        </li>
                        <li>
                            <a class="link-inner"><span> Contact Us</span></a>
                        </li>
                        <li>
                    ...
                    <div class="recent-posts">
                        ...
                        <div class="d-flex mb-4 recent-posts-box">
                            <a href="blog-details.html">
                                <img src="img/car/small-car-3.png" class="flex-shrink-0 me-3" alt="...">
                            </a>
                            <div class="align-self-center">
                                <h5>
                                    <a href="blog-details.html">Bentley Continental GT</a>
                                </h5>
                        ...
                        <div class="d-flex mb-4 recent-posts-box">
                            <a href="blog-details.html">
                                <img src="img/car/small-car-1.png" class="flex-shrink-0 me-3" alt="...">
                            </a>
                            <div class="align-self-center">
                                <h5>
                                    <a href="blog-details.html">Fiat Punto Red</a>
                                </h5>
                                <div class="listing-post-meta">
                        ...
                        <div class="d-flex recent-posts-box">
                            <a href="blog-details.html">
                                <img src="img/car/small-car-2.png" class="flex-shrink-0 me-3" alt="...">
                            </a>
                            <div class="align-self-center">
                                <h5>
                                    <a href="blog-details.html">Nissan Micra Gen5</a>
                                </h5>
                                <div class="listing-post-meta">
                ...
                <div class="footer-item clearfix">
                    ...
                    <div class="newsletter-content-wrap">
                        <form class="newsletter-form d-flex" action="#">
                            <input class="form-control me-2" type="email" id="email" placeholder="Email Address...">
