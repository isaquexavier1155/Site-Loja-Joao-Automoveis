                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-sm-12">
                        <div class="sorting-options2">
                            <h5>Mostrando 1-15 de 69 páginas</h5>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <div class="sorting-options">
                            <a href="{{ route('car-list-fullWidth') }}" class="change-view-btn float-right"><i class="fa fa-th-list"></i></a>
                            <a href="{{ route('car-grid-fullWidth') }}" class="change-view-btn float-right active-view-btn"><i class="fa fa-th-large"></i></a>
                        </div>
    ...
    <div class="detail">
        ...
        <div class="button-group">
            ...
            <form id="delete-form-{{ $carro->id }}" action="{{ route('car-delete', ['id' => $carro->id]) }}" method="POST">
                @csrf
                @method('DELETE')
                <button type="button" class="btn btn-danger" onclick="confirmDelete({{ $carro->id }})">Excluir</button>
            </form>
            <!-- Botão de edição -->
