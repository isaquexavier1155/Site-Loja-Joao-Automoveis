        ...
        <div class="main-title mt2">
            ...
            <div class="list-inline-listing">
                <ul class="filters filteriz-navigation clearfix">
                    ...
                    <li data-filter="1" class="btn btn-inline filtr-button filtr">Sale</li>
                    <li data-filter="2" class="btn btn-inline filtr-button filtr">Rent</li>
                    <li data-filter="3" class="btn btn-inline filtr-button filtr">Latest</li>
                </ul>
            </div>
        </div>
            ...
            <div class="cars">
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="3">
                    <div class="portfolio-item">
                        <a href="img/car/car-1.png" title="Lamborghini Huracán">
                            <img src="img/car/car-1.png" alt="gallery-photo" class="img-fluid">
                        </a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="3, 2, 1">
                    <div class="portfolio-item">
                        <a href="img/car/car-2.png" title="Lexus GS Red Car">
                            <img src="img/car/car-2.png" alt="gallery-photo" class="img-fluid">
                        </a>
                        <div class="portfolio-content">
                            <div class="portfolio-content-inner">
                                <p>Lexus GS Red Car</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="1, 2">
                    <div class="portfolio-item">
                        <a href="img/car/car-3.png" title="2015 Porsche Cayenne">
                            <img src="img/car/car-3.png" alt="gallery-photo" class="img-fluid">
                        </a>
                        <div class="portfolio-content">
                            <div class="portfolio-content-inner">
                                <p>2015 Porsche Cayenne</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="3, 2">
                    <div class="portfolio-item">
                        <a href="img/car/car-4.png" title="Toyota Corolla">
                            <img src="img/car/car-4.png" alt="gallery-photo" class="img-fluid">
                        </a>
                        <div class="portfolio-content">
                            <div class="portfolio-content-inner">
                                <p>Toyota Corolla</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="2, 1">
                    <div class="portfolio-item">
                        <a href="img/car/car-5.png" title="Toyota Prius Specs">
                            <img src="img/car/car-5.png" alt="gallery-photo" class="img-fluid">
                        </a>
                        <div class="portfolio-content">
                            <div class="portfolio-content-inner">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="3, 1">
                    <div class="portfolio-item">
                        <a href="img/car/car-6.png" title="Audi Q7 2018">
                            <img src="img/car/car-6.png" alt="gallery-photo" class="img-fluid">
                        </a>
                        <div class="portfolio-content">
                            <div class="portfolio-content-inner">
                                <p>Audi Q7 2018</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="2, 1, 3">
                    <div class="portfolio-item">
                        <a href="img/car/car-5.png" title="Toyota Prius Specs">
                            <img src="img/car/car-5.png" alt="gallery-photo" class="img-fluid">
                        </a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="3, 1, 3">
                    <div class="portfolio-item">
                        <a href="img/car/car-6.png" title="Audi Q7 2018">
                            <img src="img/car/car-6.png" alt="gallery-photo" class="img-fluid">
                        </a>
