...
<div class="team-page content-area">
    <div class="container">
        <!-- Heading -->
        <h1 class="heading-2">Team Details</h1>
        <div class="row">
            <div class="col-lg-8">
                <div class="row g-0 team-2 mb-50">
                    <div class="col-xl-4 col-lg-5 col-md-4 col-sm-12">
                        <div class="photo">
                            <img src="img/avatar/avatar-11.png" alt="avatar-9" class="img-fluid">
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-8 col-sm-12 align-self-center bg">
                        <div class="detail">
                            <h4>
                                <a href="team-detail.html">Stone Carolyn</a>
                            </h4>
                            <h5>Engineer</h5>
                            <div class="contact">
                                <ul>
                ...
                <div class="agent-biography">
                    ...
                    <ul class="comments">
                        <li>
                            <div class="comment d-flex mb-3">
                                ...
                                <div class="comment-content">
                                    <div class="comment-meta">
                                        <h6>
                                            Brandon Miller
                                            <span class="float-end">7/28/2021<a href="#">Reply</a></span>
                                        </h6>
                                    </div>
                            ...
                            <ul>
                                <li>
                                    <div class="comment d-flex mb-50">
                                        <div class="comment-author">
                                            <a href="#">
                                                <img src="img/avatar/avatar-4.png" alt="comments-user">
                                            </a>
                                        </div>
            ...
            <div class="col-lg-4">
                <div class="sidebar-right">
                    <div class="best-team widget">
                        <h3 class="sidebar-title">Best Team</h3>
                        <div class="d-flex mb-4 team-5">
                            <a href="car-details.html">
                                <img src="img/avatar/avatar-1.png" class="flex-shrink-0 me-3" alt="team">
                            </a>
                            <div class="align-self-center">
                                <h5>
                                    <a href="car-details.html">Carolyn Stone</a>
                                </h5>
                                <ul>
                                    <li>
                                        <i class="flaticon-mail"></i><a href="mailto:info@themevessel.com">info@themevessel.com</a>
                        ...
                        <div class="d-flex mb-4 team-5">
                            <a href="car-details.html">
                                <img src="img/avatar/avatar-2.png" class="flex-shrink-0 me-3" alt="team">
                            </a>
                            <div class="align-self-center">
                                <h5>
                                    <a href="car-details.html">Auro Navanth</a>
                                </h5>
                                <ul>
                                    <li>
                                        <i class="flaticon-mail"></i><a href="mailto:info@themevessel.com">info@themevessel.com</a>
                        ...
                        <div class="d-flex team-5">
                            <a href="car-details.html">
                                <img src="img/avatar/avatar-3.png" class="flex-shrink-0 me-3" alt="team">
                            </a>
                            <div class="align-self-center">
                                <h5>
                                    <a href="car-details.html">Maikel Alisa</a>
                                </h5>
                                <ul>
                                    <li>
                                        <i class="flaticon-mail"></i><a href="mailto:info@themevessel.com">info@themevessel.com</a>
                    ...
                    <div class="contact-1 financing-calculator widget widget-3">
                        <h3 class="sidebar-title">Contact for any Inquiry</h3>
                        <form action="#" method="GET" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="text" name="number" class="form-control" placeholder="Phone Number" aria-label="Phone Number">
                            </div>
                            <div class="form-group">
                                <textarea name="comment" class="form-control" placeholder="Comment"></textarea>
                            </div>
                            <div class="form-group mb-0">
                                <button type="button" class="btn btn-primary btn-4 btn-lg">Send Message</button>
                            </div>
                        </form>
                    </div>
                                ...
                                <div class="carbox-overlap-wrapper">
                                    <div class="overlap-box">
                                        <div class="overlap-btns-area">
                                            ...
                                            <div class="car-magnify-gallery">
                                                <a href="img/car/car-5.png" class="overlap-btn" data-sub-html="<h4>Toyota Prius Specs</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
                                                    <i class="fa fa-expand"></i>
                                                    <img class="hidden" src="img/car/car-5.png" alt="hidden-img">
                                                </a>
                                                <a href="img/car/car-2.png" class="hidden" data-sub-html="<h4>Lexus GS Red Car</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy....</p>">
