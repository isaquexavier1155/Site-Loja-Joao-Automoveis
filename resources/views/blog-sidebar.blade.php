    ...
    <div class="container breadcrumb-area">
        <div class="breadcrumb-areas">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="active">Blog Sedebar</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-8 col-md-12">
                ...
                <div class="blog-3">
                    <div class="blog-image">
                        <img src="img/blog/blog-1.png" alt="blog" class="img-fluid w-100">
                    ...
                    <div class="detail">
                        <div class="post-meta clearfix">
                            <ul>
                                <li>
                                    <strong><a href="#">By: Carolyn Stone</a></strong>
                                </li>
                                <li class="float-right mr-0"><a href="#"><i class="flaticon-comment"></i></a>328</li>
                                <li class="float-right"><a href="#"><i class="flaticon-calendar"></i></a>205</li>
                            </ul>
                        </div>
                        <h3>
                ...
                <div class="blog-3">
                    <div class="blog-image">
                        <img src="img/blog/blog-2.png" alt="blog" class="img-fluid w-100">
                        <div class="profile-user">
                            <img src="img/avatar/avatar-1.png" alt="user">
                        </div>
                        <div class="date-box">
                    ...
                    <div class="detail">
                        <div class="post-meta clearfix">
                            <ul>
                                <li>
                                    <strong><a href="#">By: Maikel Alisa</a></strong>
                                </li>
                                <li class="float-right mr-0"><a href="#"><i class="flaticon-comment"></i></a>328</li>
                                <li class="float-right"><a href="#"><i class="flaticon-calendar"></i></a>205</li>
                            </ul>
