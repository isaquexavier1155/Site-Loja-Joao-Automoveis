                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-6 col-sm-12">
                            <div class="sorting-options">
                                <a href="car-list-leftsidebar.html" class="change-view-btn active-view-btn float-right"><i class="fa fa-th-list"></i></a>
                                <a href="car-grid-fullWidth.html" class="change-view-btn float-right"><i class="fa fa-th-large"></i></a>
                            </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-7 col-md-12 align-self-center">
                            <div class="detail">
                                ...
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took<span class="d-none-1200"> a galley of type and scrambled it to make a type specimen book. It has survived not</span></p>
